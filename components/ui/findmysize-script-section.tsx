...
const RAW_SCRIPT = `<!-- orderly Size Finder & Chart -->
...
const orderlySizeFinderScriptSection = () => {
      ...
      <div className="bg-[#1e1e1e] rounded-xl p-6 font-mono text-sm shadow-2xl overflow-hidden border border-white/10 relative">
        ...
        <div className="space-y-2 opacity-90">
          <div className="text-gray-500">
            {"<!-- orderly Size Finder & Chart -->"}
          </div>

          <div>
            <span className="text-purple-400">&lt;div</span>{" "}
            <span className="text-blue-400">id</span>=
            <span className="text-green-400">"orderly-size-widget"</span>
            <span className="text-purple-400">&gt;&lt;/div&gt;</span>
          </div>
          ...
          <div>
            <span className="text-purple-400">&lt;div</span>{" "}
            <span className="text-blue-400">id</span>=
            <span className="text-green-400">"orderly-chart-widget"</span>
            <span className="text-purple-400">&gt;&lt;/div&gt;</span>
          </div>
          ...
          <div className="pt-4">
            ...
            <span className="text-green-400">
              "https://orderly.vercel.app/orderlyFindMySize.js"
            </span>
            <span className="text-purple-400">&gt;&lt;/script&gt;</span>
          </div>
          ...
          <div>
            ...
            <span className="text-blue-400">src</span>=
            <span className="text-green-400">
              "https://orderly.vercel.app/orderlySizeChart.js"
            </span>
            <span className="text-purple-400">&gt;&lt;/script&gt;</span>
          </div>
          ...
          <div className="pl-4">
            <span className="text-yellow-400">orderlySizeChart</span>.
            <span className="text-blue-300">init</span>({"{"})
          </div>
...
export default orderlySizeFinderScriptSection
