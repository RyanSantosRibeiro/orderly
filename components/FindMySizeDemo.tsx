...
export const FindMySizeDemo = () => {
    return (
        <section className="pb-24 px-6 relative overflow-hidden">
            ...
            />
            <Script
                src="/orderlySizeChart.js"
                strategy="afterInteractive"
                onLoad={() => {
                    // @ts-ignore
                    if (window.orderlySizeChart) {
                        // @ts-ignore
                        window.orderlySizeChart.init({
            ...
            <Script
                ...
                onLoad={() => {
                    // @ts-ignore
                    if (window.orderlySizeChartClothing) {
                        // @ts-ignore
                        window.orderlySizeChartClothing.init({
